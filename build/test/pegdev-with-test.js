...
(function() {
  var Main, Rule, Tudor, tudor, xx, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªW, ªX, ªex, ªhas, ªredefine, ªtype, ªuid,
  ...
  tudor.add([
    "01 Pegdev Constructor Usage", tudor.is, "The class and instance are expected types", "The Pegdev class is a function", ªF, function() {
      return Main;
