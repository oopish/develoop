...
/*! Pegdev 0.0.10 //// MIT Licence //// http://pegdev.oopish.com/ */

(function() {
  var Directory, Feature, File, Helper, Language, Main, PegRule, Tudor, tudor, xx, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªW, ªX, ªex, ªhas, ªis, ªisU, ªredefine, ªtype, ªuid,
  ...
  Directory = (function() {
    Directory.prototype.C = 'Directory';

    Directory.prototype.toString = function() {
      return "[object Directory]";
    };

    function Directory(main1, config) {
      this.main = main1;
      if (config == null) {
        config = {};
      }
    ...
    Directory.prototype.init = function(xx) {};
  ...
  Feature = (function() {
    Feature.prototype.C = 'Feature';

    Feature.prototype.toString = function() {
      return "[object Feature]";
    };

    function Feature(main1, config) {
      this.main = main1;
      if (config == null) {
        config = {};
      }
    ...
    Feature.prototype.init = function(xx) {};
  ...
  File = (function() {
    ...
    File.prototype.init = function(xx) {};
  ...
  Helper = (function() {
    ...
    Helper.prototype.init = function(xx) {};
  ...
  Language = (function() {
    Language.prototype.C = 'Language';

    Language.prototype.toString = function() {
      return "[object Language]";
    };

    function Language(main1, config) {
      this.main = main1;
      if (config == null) {
        config = {};
      }
    ...
    Language.prototype.init = function(xx) {};
  ...
  Main = (function() {
    ...
    Main.prototype.init = function() {
      this.helpers.push(new File(this, {
        label: 'add',
        title: 'Add',
      ...
      this.languages.push(new Directory(this, {
        label: 'md',
        title: 'Markdown',
        ...
        files: [
          new File(this, {
            ...
            title: 'bold.js',
            notes: ['Bold text'],
            value: "function md_bold(input) {\n}\n"
          }), new File(this, {
            label: 'italic_js',
            title: 'italic.js',
            notes: ['Italic text'],
            value: "function md_italic(input) {\n}\n"
          })
        ]
      }));
      this.languages.push(new Directory(this, {
        ...
        files: [
          new File(this, {
            ...
            value: "function item_js(input) {\n}\n"
          }), new File(this, {
            label: 'list_js',
            title: 'List.js',
            notes: ['The List class'],
            value: "function list_js(input) {\n}\n"
          })
        ]
      }));
      this.oopish.push(new Directory(this, {
        label: 'build',
        title: 'build',
        ...
        files: [
          new File(this, {
            ...
            value: "//// Mode generated by Pegdev 0.0.7\n\nmodeGrammar = {\n}\n"
          }), new File(this, {
      ...
      this.oopish.push(new Directory(this, {
        ...
        files: [
          new File(this, {
            ...
            value: "//// Grammar helpers generated by Pegdev 0.0.7\nvar someHelper = function () { return 'ok'; };\n"
          }), new File(this, {
            ...
            value: "//// Grammar rules generated by Pegdev 0.0.7\n\nmodeGrammar = {\n}\n"
          })
        ]
      }));
      this.oopish.push(new Directory(this, {
      ...
      this.project.push(new Directory(this, {
        label: 'build',
        title: 'build',
        ...
        files: [
          new File(this, {
            ...
            value: "var abc=123;console.log(abc);"
          }), new File(this, {
      ...
      this.project.push(new Directory(this, {
        ...
        files: [
          new File(this, {
            ...
            value: "Test 02: Useful\n===============\n"
          })
        ]
      }));
      this.project.push(new File(this, {
        label: 'readme_md',
        title: 'README.md',
        notes: ['An introduction to the project'],
        value: "Example Project'\n===============\n\nAn example Pegdev project. \n"
      }));
      return this.project.push(new File(this, {
        label: 'package_json',
        title: 'package.json',
  ...
  PegRule = (function() {
    PegRule.prototype.C = 'PegRule';

    PegRule.prototype.toString = function() {
      return "[object " + this.C + "]";
    };

    function PegRule(main1, config) {
      var result, ruleRx;
      this.main = main1;
      if (config == null) {
        config = {};
      ...
      if ('_' !== config.label[0]) {
        throw "Label '" + config.label + "' does not start '_'";
      }
      this.label = config.label;
      this.humanName = config[ªis(ªisU(config.humanName), 'label', 'humanName')];
      this.initializer = ªisU(config.initializer) ? "// " + this.label + " has no initializer" : config.initializer;
      this.rule = ªisU(config.rule) ? "// " + this.label + " has no rule" : config.rule;
      this.usedRuleLut = {};
      ruleRx = /[\s:]+(_[_a-z0-9]+)/gi;
      while (null !== (result = ruleRx.exec(" " + this.rule + " "))) {
        this.usedRuleLut[result[1]] = true;
      }
      this.optionalOrs = ªisU(config.optionalOrs) ? [] : config.optionalOrs;
      this.inert = ªisU(config.inert) ? true : config.inert;
      this.init();
    }

    PegRule.prototype.init = function() {};

    PegRule.prototype.getActiveOrs = function() {
      var j, len, optionalOr, out, ref, rule;
      out = [];
      ref = this.optionalOrs;
      for (j = 0, len = ref.length; j < len; j++) {
        optionalOr = ref[j];
        rule = this.main.pegRuleLut[optionalOr];
        if (!rule) {
          throw "Optional-or rule '" + optionalOr + "' does not exist";
        }
        if (!rule.inert) {
          out.push(rule.label);
        }
    ...
    PegRule.prototype.getInitializer = function() {
      if (this.inert) {
        return "// " + this.label + " '" + this.humanName + "' is inert\n";
      } else {
        return "// " + this.label + " '" + this.humanName + "' initializer\n" + this.initializer + "\n;\n";
      }
    };

    PegRule.prototype.getRule = function() {
      var activeOrs;
      if (this.inert) {
        return "// " + this.label + " '" + this.humanName + "' is inert\n";
      } else {
        activeOrs = this.getActiveOrs();
        return "// " + this.label + " rule\n" + this.label + " '" + this.humanName + "'\n" + this.rule + "\n" + (activeOrs.length ? '  / ' + activeOrs.join('\n  / ') : '') + "\n;\n";
      }
    };

    PegRule.prototype.getModeStyles = function() {
      var modeStyles;
      modeStyles = {};
      modeStyles[this.label] = 'comment';
      return modeStyles;
    };

    PegRule.prototype.getModeLexes = function() {
      var modeLexes;
      modeLexes = {};
      modeLexes[this.label] = "{\n    type: \"comment\",\n    tokens: [\n        // block comments\n        // start,    end  delims\n        [ \"<!--\",    \"-->\" ]\n    ]\n  }";
      return modeLexes;
    };
  ...
  Main = (function() {
    ...
    Main.prototype.init = function() {
      var rule;
      rule = new PegRule(this, {
        label: '_interpolation',
        humanName: 'Interpolation',
        initializer: "function stringProcess(chars) {\n  return 'I found ' + chars.join('') + '!';\n}",
        rule: '  ' + "= '`' chars:_string_not_backtick* '`'\n    { return stringProcess(chars); }"
      });
      this.pegRules.push(rule);
      this.pegRuleLut[rule.label] = rule;
      rule = new PegRule(this, {
        label: '_string_not_backtick',
        humanName: 'String Not Backtick',
        rule: '  ' + "= !'`' char:_string_char { return char; }"
      });
      this.pegRules.push(rule);
      this.pegRuleLut[rule.label] = rule;
      rule = new PegRule(this, {
      ...
      this.pegRules.push(rule);
      return this.pegRuleLut[rule.label] = rule;
    };

    Main.prototype.renderInitializer = function() {
      var inertTally, j, len, out, ref, rule;
      inertTally = 0;
      ref = this.pegRules;
      for (j = 0, len = ref.length; j < len; j++) {
        rule = ref[j];
      ...
      if (0 === this.pegRules.length || this.pegRules.length === inertTally) {
        ...
        out = out.concat((function() {
          ...
          for (k = 0, len1 = ref1.length; k < len1; k++) {
            rule = ref1[k];
            results.push(rule.getInitializer());
          }
          return results;
        }).call(this));
    ...
    Main.prototype.renderRules = function() {
      var inertTally, j, len, out, ref, rule;
      inertTally = 0;
      ref = this.pegRules;
      for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (0 === this.pegRules.length) {
        out.push("//// No rules have been defined. \n");
        out.push("start = ''");
      } else if (this.pegRules.length === inertTally) {
        out.push("//// The " + this.pegRules.length + " rules are inert. \n");
        out.push("start = ''");
      } else {
        ...
        out = out.concat((function() {
          ...
          for (k = 0, len1 = ref1.length; k < len1; k++) {
            rule = ref1[k];
            results.push(rule.getRule());
          }
          return results;
        }).call(this));
        out.push("\n\n//// " + this.pegRules.length + " rules, " + inertTally + " inert. \n");
      }
      return out.join('\n') + '\n\n';
    };

    Main.prototype.renderMode = function() {
      var inertTally, j, k, key, l, len, len1, len2, len3, m, out, ref, ref1, ref2, ref3, ref4, ref5, rule, val;
      inertTally = 0;
      ref = this.pegRules;
      for (j = 0, len = ref.length; j < len; j++) {
        rule = ref[j];
  ...
  tudor.add([
    "01 Pegdev Constructor Usage", tudor.is, "(Set up a `main` instance)", function() {
      return [new Main];
    }, "The class and instance are expected types", "The Pegdev class is a function", ªF, function() {
      return Main;
    }, "`new` returns an object", ªO, function(main) {
      return main;
    }, "`pegjs` is an object", ªO, function(main) {
      return main.pegjs;
    }, tudor.equal, "`Pegdev.toString()` is '[object Pegdev]'", '[object Pegdev]', function(main) {
      return '' + main;
    }, "`pegjs.toString()` is '[object Object]'", '[object Object]', function(main) {
      return '' + main.pegjs;
    }, "`pegjs.VERSION` is '0.9.0'", '0.9.0', function(main) {
      return main.pegjs.VERSION;
    }, "`pegjs.buildParser` is a function", ªF, function(main) {
      return typeof main.pegjs.buildParser;
    }, tudor["throw"], function(main) {
      return [main, main.pegjs.buildParser("start = ('a' / 'b')+")];
    }, tudor.is, "`pegjs.buildParser(\"start = ('a' / 'b')+\")` returns an object", ªO, function(main, parser) {
      return parser;
    }, "The object has a `parse()` method", ªF, function(main, parser) {
      return parser.parse;
    }, tudor["throw"], "Calling `parse('')` throws a well written exception", 'Expected "a" or "b" but end of input found.', function(main, parser) {
      return parser.parse('');
    }, tudor.is, "Calling `parse('a')` returns an array", ªA, function(main, parser) {
      return parser.parse('a');
    }, tudor.equal, "The returned array has one element", 1, function(main, parser) {
      return parser.parse('a').length;
    }, "The element is the string 'a'", 'a', function(main, parser) {
      return parser.parse('a')[0];
    }, "`parser.parse('babba')` has 5 elements 'b,a,b,b,a'", 'b,a,b,b,a', function(main, parser) {
      return parser.parse('babba').join(',');
    }
  ]);
...
*
**/!function(e,t,n){"use strict";var r,o="object"==typeof module&&module.exports,l="function"==typeof define&&define.amd;o?module.exports=(module.$deps=module.$deps||{})[t]=module.$deps[t]||n.call(e,{NODE:module})||1:l&&"function"==typeof require&&"function"==typeof require.specified&&require.specified(t)?define(t,["require","exports","module"],function(t,r,o){return n.call(e,{AMD:o})}):t in e||(e[t]=r=n.call(e,{})||1)&&l&&define(t,[],function(){return r})}(this,"AceGrammar",function(e){"use strict";function t(e,t){var n,r=this;return(n=e.chr(r.tp,t))?[r.tk,n]:!1}function n(e,t){var n,r=this;return(n=e.chl(r.tp,t))?[r.tk,n]:!1}function r(e,t){var n,r=this;return(n=e.str(r.tp,r.p,t))?[r.tk,n]:!1}function o(e,t){var n,r=this;return(n=e.rex(r.tp,r.p,r.np,r.tg,t))?[r.tk,n]:!1}function l(e,t){var n=this;return!1!==t&&e.end(),[n.tk,""]}function s(e,t,n,r){var o=gt(t);if(Y===o)return t;if(r[e])return r[e];n=n||0;var l,s=0;return t&&t.isCharList&&(s=1,delete t.isCharList),l=ct&o?new Ut(ct,e,t,n):nt===o?new Ut(nt,e,t,n):tt&o?s?new Ut(rt,e,t,n):new Ut(tt,e,t,n):ot&o?new Ut(it,e,t,n):t,r[e]=l}function i(e,t,n,r,o,l){if(l[e])return l[e];var u,c,a,p,f,h,g,m=0,k=0,d=1;if(u=Et(t),a=u.length,1===a)g=s(e,Bt(u[0],n,o),0,l);else if(a>1){for(p=(a>>1)+1,c=0;p>=c;c++)f=gt(u[c]),h=gt(u[a-1-c]),(nt!==f||nt!==h)&&(d=0),ot&f||ot&h?m=1:(Mt(u[c],n)||Mt(u[a-1-c],n))&&(k=1);if(!d||r&&tt&gt(r))if(!r||m||k){for(c=0;a>c;c++)u[c]=ot&gt(u[c])?i(e+"_"+c,u[c],n,r,o,l):s(e+"_"+c,Bt(u[c],n,o),c,l);g=a>1?new zt(e,u):u[0]}else g=s(e,It(u,r),0,l);else u=u.slice().join(""),u.isCharList=1,g=s(e,u,0,l)}return l[e]=g}function u(e,t,n,r,o){if(o[e])return o[e];var l,i,u,c,a,p,f;for(c=[],a=[],l=vt(t),i=0,u=l.length;u>i;i++)p=s(e+"_0_"+i,Bt(l[i][0],n,r),i,o),f=l[i].length>1?it!==p.tt||tt!==gt(l[i][1])||Mt(l[i][1],n)?s(e+"_1_"+i,Bt(l[i][1],n,r),i,o):l[i][1]:p,c.push(p),a.push(f);return o[e]=new $t(e,c,a)}function c(e,t,n){var r,o,l,s,i,u,c,a,p,f,h,g;if(u=new String(xt(e)),u.pos=0,1===u.length)f=""+e,t[f]||(t[f]={type:"simple",tokens:e}),e=f;else{for(r=[],o=[],l="",h=[];u.pos<u.length;)if(a=u.charAt(u.pos++),Lt.test(a))if(l.length&&(t[l]||n[l]||(t[l]={type:"simple",tokens:l}),o.push(l),l=""),'"'===a||"'"===a){for(c=a,s="";u.pos<u.length&&c!==(a=u.charAt(u.pos++));)s+=a;s.length?(f=""+s,t[f]||(t[f]={type:"simple",tokens:s}),o.push(f)):o.push(0)}else if("*"===a||"+"===a||"?"===a)p=o.pop(),f=""+p+a,n[f]||(n[f]={type:"group",match:"*"===a?"zeroOrMore":"+"===a?"oneOrMore":"zeroOrOne",tokens:[p]}),o.push(f);else if("{"===a){for(i="";u.pos<u.length&&"}"!==(a=u.charAt(u.pos++));)i+=a;i=i.split(",").map(xt),i[0]=i[0].length?parseInt(i[0],10)||0:0,0>i[0]&&(i[0]=0),2>i.length?i.push(i[0]):i[1]=i[1].length?parseInt(i[1],10)||R:R,0>i[1]&&(i[1]=0),p=o.pop(),f=""+p+["{",i[0],",",isFinite(i[1])?i[1]:"","}"].join(""),n[f]||(n[f]={type:"group",match:[i[0],i[1]],tokens:[p]}),o.push(f)}else{if("}"===a)continue;if("["===a){for(s="";u.pos<u.length&&"]"!==(a=u.charAt(u.pos++));)s+=a;f="["+s+"]",t[f]||(t[f]={type:"simple",tokens:s.split("")}),o.push(f)}else{if("]"===a)continue;"|"===a?(o.length>1?(f=""+o.join(" "),n[f]||(n[f]={type:"group",match:"sequence",tokens:o}),r.push(f)):o.length&&r.push(o[0]),o=[]):"("===a?(h.push([o,r,l]),o=[],r=[],l=""):")"===a&&(o.length>1?(f=""+o.join(" "),n[f]||(n[f]={type:"group",match:"sequence",tokens:o}),r.push(f)):o.length&&r.push(o[0]),o=[],r.length>1?(f=""+r.join(" | "),n[f]||(n[f]={type:"group",match:"either",tokens:r})):r.length&&(f=r[0]),r=[],g=h.pop(),o=g[0],r=g[1],l=g[2],p=f,f="("+p+")",n[f]||(n[f]=Rt(t[p]||n[p])),o.push(f))}}else l+=a;l.length&&(t[l]||n[l]||(t[l]={type:"simple",tokens:l}),o.push(l)),l="",o.length>1?(f=""+o.join(" "),n[f]||(n[f]={type:"group",match:"sequence",tokens:o}),r.push(f)):o.length&&r.push(o[0]),o=[],r.length>1?(f=""+r.join(" | "),n[f]||(n[f]={type:"group",match:"either",tokens:r}),e=f):r.length&&(e=r[0]),r=[]}return e}function a(e,t,n,r,o,l,s,h,g,m,k){var d,w,y,C,O,M,P,q,U,F,K,W,Z,H,Y,J,X=null;if(null===e)return new Ft(b,"EOL",e);if(""===e)return new Ft(S,"NONSPACE",e);if(!1===e||0===e)return new Ft(x,"EMPTY",e);if(ot&gt(e)&&(J=e,e="NGRAM_"+J.join("_"),r[e]||(r[e]={type:"ngram",tokens:J})),e=""+e,h[e])return h[e];for(n[e]?(d=n[e],ft&gt(d)&&(d=n[e]={type:"simple",tokens:d})):d=r[e]?r[e]:e,tt&gt(d)&&(d=c(d,n,r),d=n[d]||r[d]);d.extend;)H=d.extend,Y=n[H]||r[H],delete d.extend,Y&&(ft&gt(Y)&&(Y={type:"simple",tokens:Y}),d=wt(Y,d));if("undefined"==typeof d.type&&(d.all||d.sequence?(d.type="group",d.match="sequence",d.tokens=d.all||d.sequence,d.all?delete d.all:delete d.sequence):d.either?(d.type="group",d.match="either",d.tokens=d.either,delete d.either):d.zeroOrMore?(d.type="group",d.match="zeroOrMore",d.tokens=d.zeroOrMore,delete d.zeroOrMore):d.oneOrMore?(d.type="group",d.match="oneOrMore",d.tokens=d.oneOrMore,delete d.oneOrMore):d.zeroOrOne?(d.type="group",d.match="zeroOrOne",d.tokens=d.zeroOrOne,delete d.zeroOrOne):d.comment?(d.type="comment",d.tokens=d.comment,delete d.comment):d.block?(d.type="block",d.tokens=d.block,delete d.block):d["escaped-block"]?(d.type="escaped-block",d.tokens=d["escaped-block"],delete d["escaped-block"]):d.simple?(d.type="simple",d.tokens=d.simple,delete d.simple):d.type="simple"),w=d.type?z[d.type.toUpperCase().replace(Tt,"")]:_,_&w){if(""===d.tokens)return X=new Ft(S,e,e),h[e]=X,X;if(null===d.tokens)return X=new Ft(b,e,e),h[e]=X,X;if(!1===d.tokens||0===d.tokens)return X=new Ft(x,e,e),h[e]=X,X}if(d.tokens=Et(d.tokens),_&w)d.autocomplete&&f(d,e,k),d.push?(d.action||(d.action=["push",d.push]),delete d.push):d[V]("pop")&&(d.action||(d.action=["pop",d.pop]),delete d.pop),C=null,d.action&&d.action[0]&&("push"===d.action[0]?C=[E,d.action[1]]:"pop"===d.action[0]&&(C=[v,d.action[1]])),y="undefined"==typeof d.combine?"\\b":d.combine,X=new Ft(_,e,i(e,d.tokens.slice(),t,y,l,s)),X.ta=C,h[e]=X;else if(A&w)T&w&&p(d,m),X=new Kt(w,e,u(e,d.tokens.slice(),t,l,s),d.multiline,d.escape,o[e+".inside"]?1:0),h[e]=X,d.interleave&&g.push(X.clone());else if(N&w){for(M=d.tokens.slice(),ot&gt(d.match)?X=new Vt(I,e,null,d.match[0],d.match[1]):(O=$[d.match.toUpperCase()],X=j===O?new Vt(j,e,null,0,1):D===O?new Vt(D,e,null,0,R):G===O?new Vt(G,e,null,1,R):L&O?new Vt(L,e,null):new Vt(B,e,null)),h[e]=X,P=[],F=0,K=M.length;K>F;F++)P=P.concat(a(M[F],t,n,r,o,l,s,h,g,m,k));X.set(P)}else if(Q&w){for(X=vt(d.tokens.slice()).slice(),q=[],F=0,K=X.length;K>F;F++)q[F]=X[F].slice(),X[F]=new Vt(Q,e+"_NGRAM_"+F,null);for(h[e]=X,F=0,K=X.length;K>F;F++){for(U=q[F],P=[],W=0,Z=U.length;Z>W;W++)P=P.concat(a(U[W],t,n,r,o,l,s,h,g,m,k));X[F].set(P)}}return h[e]}function p(e,t){var n,r,o,l,s,i=vt(e.tokens.slice());for(l=0,s=i.length;s>l;l++)n=i[l][0],r=i[l].length>1?i[l][1]:i[l][0],o=i[l].length>2?i[l][2]:"",null===r?(t.line=t.line||[],t.line.push(n)):(t.block=t.block||[],t.block.push([n,r,o]))}function f(e,t,n){var r=[].concat(Et(e.tokens)).map(function(e){return{word:e,meta:t}});n.autocomplete=(n.autocomplete||[]).concat(r)}function h(e){var t,n,r,o,l,s,i,u,c,p,f,h,g,m,k,d;if(e.__parsed)return e;for(f={},h={},g={},k={},d={},m=[],e=Rt(e),t=e.RegExpID||null,e.RegExpID=null,delete e.RegExpID,s=e.Lex||{},e.Lex=null,delete e.Lex,i=e.Syntax||{},e.Syntax=null,delete e.Syntax,l=e.Style||{},o=e.Parser||[],r=o.length,n=[],u=0;r>u;u++)c=o[u],p=a(c,t,s,i,l,f,h,g,m,k,d)||null,p&&(ot&gt(p)?n=n.concat(p):n.push(p));return e.Parser=n,e.cTokens=m,e.Style=l,e.Comments=k,e.Keywords=d,e.Extra=e.Extra||{},e.__parsed=1,e}function g(){ace.define("ace/grammar_worker",["require","exports","module","ace/worker/mirror"],function(e,t){var n,r=e("./worker/mirror").Mirror;t.AceGrammarWorker=n=dt(r,{constructor:function(e){var t=this;r.call(t,e),t.setTimeout(500)},parser:null,Init:function(e,t){var n=this;n.parser=new ln(h(e),{DEFAULT:k,ERROR:d}),n.sender.callback(1,t)},onUpdate:function(){var e,t,n,r,o,l,s,i,u,c=this,a=c.sender,p=c.parser,f=0;if(!p)return void a.emit("ok",null);if(e=c.doc.getValue(),!e||!e.length)return void a.emit("ok",null);for(r=[],t=p.parse(e),l=t.length,o=0;l>o;o++)if(n=t[o],n&&n.length)for(u=0,s=0;s<n.length;s++)i=n[s],p.ERR==i.type&&(r.push({row:o,column:u,text:i.error||"Syntax Error",type:"error",raw:i.error||"Syntax Error"}),f=1),u+=i.value.length;f?a.emit("error",r):a.emit("ok",null)}})})}function m(e,t){var n,r=Rt(e),o=new ln(h(e),{DEFAULT:t||k,ERROR:d});return n={getTokenizer:function(){return o},supportGrammarAnnotations:!1,createWorker:function(e){if(!n.supportGrammarAnnotations)return e.clearAnnotations(),null;Jt.setModuleUrl("ace/grammar_worker",rn.file);var t=new on(["ace"],"ace/grammar_worker","AceGrammarWorker");return t.attachToDocument(e.getDocument()),t.call("Init",[r],function(){t.on("error",function(t){e.setAnnotations(t.data)}),t.on("ok",function(){e.clearAnnotations()})}),t},transformAction:function(){},toggleCommentLines:function(e,t,n,r){return o.tCL(e,t,n,r)},toggleBlockComment:function(e,t,n,r){return o.tBC(e,t,n,r)},getNextLineIndent:function(e,t,n){return o.getNextLineIndent(e,t,n)},checkOutdent:function(){return!1},autoOutdent:function(){},getKeywords:function(){var e=o.Keywords;return e?e.map(function(e){var t=e.word,n=e.meta;return{name:t,value:t,score:1e3,meta:n}}):[]},getCompletions:function(e,t,n,r){var l=o.Keywords;if(!l)return[];var s=r.length;return l.map(function(e){var t=e.word,n=e.meta,o=t.length,l=o>=s&&r===t.substr(0,s);return{name:t,value:t,score:l?1e3-o:0,meta:n}})}}}var k,d,E=1,v=2,R=1/0,w=2,y=4,C=8,_=16,b=17,S=18,x=20,A=32,O=33,T=34,L=64,M=128,B=M,I=256,j=257,D=258,G=259,N=512,Q=1024,P=B|Q,q=2048,U=4096,$={EITHER:L,ALL:M,SEQUENCE:B,ZEROORONE:j,ZEROORMORE:D,ONEORMORE:G,REPEATED:I},z={INDENT:q,DEDENT:U,BLOCK:A,COMMENT:T,ESCAPEDBLOCK:O,SIMPLE:_,GROUP:N,NGRAM:Q},F=void 0,K="prototype",V="hasOwnProperty",W="propertyIsEnumerable",Z=(Object.keys,Array[K],Object[K]),H=(Function[K],Z.toString),Y=4,J=5,X=6,et=8,tt=16,nt=17,rt=18,ot=32,lt=64,st=128,it=256,ut=512,ct=1024,at=2048,pt=4096,ft=tt|ot,ht={"[object Number]":Y,"[object String]":tt,"[object Array]":ot,"[object RegExp]":it,"[object Date]":ut,"[object Function]":st,"[object Object]":lt},gt=function(e){if(null===e)return ct;if(!0===e||!1===e||e instanceof Boolean)return et;if(F===e)return at;var t=ht[H.call(e)]||pt;return Y===t||e instanceof Number?isNaN(e)?X:isFinite(e)?Y:J:tt===t||e instanceof String?1===e.length?nt:tt:ot===t||e instanceof Array?ot:it===t||e instanceof RegExp?it:ut===t||e instanceof Date?ut:st===t||e instanceof Function?st:lt===t?lt:pt},mt=function(){var e,t,n,r,o,l,s=arguments,i=s.length;for(e=s[0]||{},o=1;i>o;o++)if(t=s[o],lt===gt(t))for(r in t)t[V](r)&&t[W](r)&&(n=t[r],l=gt(n),e[r]=Y&l?0+n:ft&l?n.slice():n);return e},kt=Object.create,dt=function(e,t){var n,r=arguments.length,o="constructor";return 0===r?(e=Object,t={}):1===r?(t=e||{},e=Object):(e=e||Object,t=t||{}),t[V](o)||(t[o]=function(){}),n=t[o],delete t[o],n[K]=mt(kt(e[K]),t),n[K][o]=n,n},Et=function(e,t){return t||ot!==gt(e)?[e]:e},vt=function(e,t){return e=Et(e),(t||ot!==gt(e[0]))&&(e=[e]),e},Rt=function(e,t){var n,r,o,l,s=gt(e);if(t=!1!==t,lt===s){r={};for(o in e)e[V](o)&&e[W](o)&&(n=gt(e[o]),r[o]=lt===n?t?Rt(e[o],t):e[o]:ot===n?t?Rt(e[o],t):e[o].slice():tt&n?e[o].slice():Y&n?0+e[o]:e[o])}else if(ot===s)for(l=e.length,r=new Array(l),o=0;l>o;o++)n=gt(e[o]),r[o]=lt===n?t?Rt(e[o],t):e[o]:ot===n?t?Rt(e[o],t):e[o].slice():tt&n?e[o].slice():Y&n?0+e[o]:e[o];else r=tt&s?e.slice():Y&s?0+e:e;return r},wt=function(){var e,t,n,r,o,l,s,i,u,c,a=arguments,p=a.length;if(1>p)return null;for(t=Rt(a[0]),n=1;p>n;n++)if(e=a[n])for(r in e)if(e[V](r)&&e[W](r))if(t[V](r)&&t[W](r)){if(u=gt(t[r]),c=gt(e[r]),lt===u&&lt===c)t[r]=wt(t[r],e[r]);else if(ot===u&&ot===c){if(s=t[r],i=e[r],l=i.length,!l)continue;if(s.length)for(o=0;l>o;o++)0>s.indexOf(i[o])&&s.push(i[o]);else t[r]=i.slice()}}else t[r]=Rt(e[r]);return t},yt=/([.*+?^${}()|[\]\/\\\-])/g,Ct=function(e){return e.replace(yt,"\\$1")},_t=/\$(\d{1,2})/g,bt=function(e,t){var n,r,o,l;for(l=function(e,n){return t[1+parseInt(n,10)]},n=e.split("$$"),o=n.length,r=0;o>r;r++)n[r]=n[r].replace(_t,l);return n.join("$")},St=/^\s+|\s+$/g,xt=String[K].trim?function(e){return e.trim()}:function(e){return e.replace(St,"")},At=function(e,t){return t.length-e.length},Ot=/\r\n|\r|\n/g,Tt=/[\-_]/g,Lt=/^([\[\]{}()*+?|'"]|\s)/,Mt=function(e,t){return tt&gt(t)&&tt&gt(e)&&t.length&&t.length<=e.length&&t==e.substr(0,t.length)},Bt=function(e,t,n){if(!e||Y===gt(e))return e;var r,o=t?t.length||0:0;if(o&&t==e.substr(0,o)){var l,s,i,u,r,c,a=e.substr(o),p=a[0],f="";for(r=a.length;r--&&(c=a[r],p!=c);)"i"==c.toLowerCase()&&(f="i");return l=a.substring(1,r),s="^("+l+")",n[s]||(i=new RegExp(s,f),u={peek:null,negativepeek:null},n[s]=[i,u]),n[s]}return e},It=function(e,t){var n={},r="",o=gt(t);(tt===o||nt===o)&&(r=t);var l=e.sort(At).map(function(e){return n[e.charAt(0)]=1,Ct(e)}).join("|");return[new RegExp("^("+l+")"+r),{peek:n,negativepeek:null},1]},jt=0,Dt=function(){return++jt},Gt=function(e){return[e||"uuid",++jt,(new Date).getTime()].join("_")},Nt=Math.max,Qt=/^[\s\u00a0]+/,Pt=/[^\s\u00a0]/,qt=dt({constructor:function(e){var t=this;t._=null,t.s=e?""+e:"",t.start=t.pos=0,t.lCP=t.lCV=0,t.lS=0},_:null,s:"",start:0,pos:0,lCP:0,lCV:0,lS:0,dispose:function(){var e=this;return e._=null,e.s=null,e.start=null,e.pos=null,e.lCP=null,e.lCV=null,e.lS=null,e},toString:function(){return this.s},sol:function(){return 0===this.pos},eol:function(){return this.pos>=this.s.length},chr:function(e,t){var n=this,r=n.s.charAt(n.pos)||null;return r&&e===r?(!1!==t&&(n.pos+=1,n._&&(n._.pos=n.pos)),r):!1},chl:function(e,t){var n=this,r=n.s.charAt(n.pos)||null;return r&&-1<e.indexOf(r)?(!1!==t&&(n.pos+=1,n._&&(n._.pos=n.pos)),r):!1},str:function(e,t,n){var r,o=this,l=o.pos,s=o.s,i=s.charAt(l)||null;return i&&t[i]&&(r=e.length,e===s.substr(l,r))?(!1!==n&&(o.pos+=r,o._&&(o._.pos=o.pos)),e):!1},rex:function(e,t,n,r,o){{var l,s=this,i=s.pos,u=s.s;u.charAt(i)||null}return l=u.slice(i).match(e),!l||l.index>0?!1:(!1!==o&&(s.pos+=l[r||0].length,s._&&(s._.pos=s.pos)),l)},spc:function(e){var t,n=this,r=n.pos,o=n.s.slice(r);return(t=o.match(Qt))?(!1!==e&&(n.pos+=t[0].length,n._&&(n._.pos=n.pos)),1):0},end:function(){var e=this;return e.pos=e.s.length,e._&&(e._.pos=e.pos),e},nxt:function(){var e,t=this,n=t.s;return t.pos<n.length?(e=n.charAt(t.pos++)||null,t._&&(t._.pos=t.pos),e):void 0},bck:function(e){var t=this;return t.pos=Nt(0,t.pos-e),t._&&(t._.pos=t.pos),t},bck2:function(e){var t=this;return t.pos=Nt(0,e),t._&&(t._.pos=t.pos),t},col:function(e){var t=this;return e=e||1,t.lCP<t.start&&(t.lCV=qt.col(t.s,t.start,e,t.lCP,t.lCV),t.lCP=t.start,t._&&(t._.start=t.start,t._.lastColumnPos=t.lCP,t._.lastColumnValue=t.lCV,t._.lineStart=t.lS)),t.lCV-(t.lS?qt.col(t.s,t.lS,e):0)},ind:function(e){var t=this;return e=e||1,qt.col(t.s,null,e)-(t.lS?qt.col(t.s,t.lS,e):0)},cur:function(e){var t=this,n=t.s.slice(t.start,t.pos);return e&&(t.start=t.pos),n},sft:function(){return this.start=this.pos,this}});qt.col=function(e,t,n,r,o){var l,s;for(null===t&&(t=e.search(Pt),-1==t&&(t=e.length)),l=r||0,s=o||0;t>l;++l)s+="	"==e.charAt(l)?n-s%n:1;return s},qt._=function(e){var t=new qt;return t._=e,t.s=""+e.string,t.start=e.start,t.pos=e.pos,t.lCP=e.lastColumnPos,t.lCV=e.lastColumnValue,t.lS=e.lineStart,t};var Ut,$t,zt,Ft,Kt,Vt,Wt=dt({constructor:function(e){this._=e||[]},_:null,dispose:function(){var e=this;return e._=null,e},toString:function(){return this._.slice().reverse().join("\n")},clone:function(){return new Wt(this._.slice())},isEmpty:function(){return 0>=this._.length},pos:function(){return this._.length},peek:function(e){var t=this,n=t._;if(e=arguments.length?e:-1,n.length){if(0>e&&0<=n.length+e)return n[n.length+e];if(e>=0&&e<n.length)return n[e]}return null},pop:function(){return this._.pop()},shift:function(){return this._.shift()},push:function(e){var t=this;return t._.push(e),t},unshift:function(e){var t=this;return t._.unshift(e),t},pushAt:function(e,t,n,r){var o=this,l=o._;return n&&r&&(t[n]=r),e<l.length?l.splice(e,0,t):l.push(t),o},empty:function(e,t){{var n=this,r=n._;r.length}if(e&&t)for(;r.length&&r[r.length-1]&&r[r.length-1][e]===t;)r.pop();else r.length=0;return n}}),Zt=dt({constructor:function(e,t){var n=this;n.id=t?Gt("state"):"state",n.l=e||0,n.stack=new Wt,n.data=new Wt,n.col=0,n.indent=0,n.t=null,n.inBlock=null,n.endBlock=null},id:null,l:0,col:0,indent:0,stack:null,data:null,t:null,inBlock:null,endBlock:null,dispose:function(){var e=this;return e.stack&&e.stack.dispose(),e.data&&e.data.dispose(),e.stack=null,e.data=null,e.id=null,e.t=null,e.l=null,e.col=null,e.indent=null,e.inBlock=null,e.endBlock=null,e},clone:function(e){var t=this,n=new Zt(t.l,e);return n.t=t.t,n.col=t.col,n.indent=t.indent,n.stack=t.stack.clone(),n.data=t.data.clone(),n.inBlock=t.inBlock,n.endBlock=t.endBlock,n},toString:function(){var e=this;return["",e.id,e.l,e.t,e.inBlock||"0"].join("_")}});Ut=dt({constructor:function(e,s,i,u){var c=this;switch(c.mt=w,c.tt=e||nt,c.tn=s,c.tk=u||0,c.tg=0,c.tp=null,c.p=null,c.np=null,c.tt){case nt:case rt:c.tp=i,c.get=rt===c.tt?n:t;break;case tt:c.tp=i,c.p={},c.p[""+i.charAt(0)]=1,c.get=r;break;case it:c.tp=i[0],c.p=i[1].peek||null,c.np=i[1].negativepeek||null,c.tg=i[2]||0,c.get=o;break;case ct:c.tp=null,c.get=l}},mt:null,tt:null,tn:null,tp:null,tg:0,tk:0,p:null,np:null,get:function(){return!1},toString:function(){var e=this;return["[","Matcher: ",e.tn,", Pattern: ",e.tp?e.tp.toString():null,"]"].join("")}}),zt=dt(Ut,{constructor:function(e,t,n){var r=this;r.mt=y,r.tn=e,r.ms=t,r.ownKey=!1!==n},ms:null,ownKey:!0,get:function(e,t){var n,r,o=this,l=o.ms,s=l.length,i=o.ownKey;for(n=0;s>n;n++)if(r=l[n].get(e,t))return i?[n,r[1]]:r;return!1}}),$t=dt(Ut,{constructor:function(e,t,n){var r=this;r.mt=C,r.tn=e,r.s=new zt(r.tn+"_Start",t,!1),r.e=n},s:null,e:null,get:function(e,t){var n,r=this,o=r.s,l=r.e;if(n=o.get(e,t)){var s,i=l[n[0]],u=gt(i),c=o.ms[n[0]].tt;return it===c&&(Y===u?(s=n[1][i+1],i=new Ut(s.length>1?tt:nt,r.tn+"_End",s)):tt===u&&(s=bt(i,n[1]),i=new Ut(s.length>1?tt:nt,r.tn+"_End",s))),i}return!1}}),Ft=dt({constructor:function(e,t,n){var r=this;r.tt=e||_,r.id=t,r.tk=n,r.REQ=0,r.ERR=0,r.ACTER=0,r.MSG=null,r.CLONE=["tk"]},sID:null,id:null,tt:null,tk:null,ta:null,REQ:0,ERR:0,ACTER:0,MSG:null,CLONE:null,act:function(e,t){var n,r,o=this,l=o.ta||null,s=t.data;if(l)if(n=l[0],r=l[1],v===n)if(r){if(e&&(r=Y===gt(r)?e[1][r]:bt(r,e[1])),s.isEmpty()||r!==s.peek())return o.MSG='Token "'+r+'" No Match',s.pop(),1;s.pop()}else s.pop();else E===n&&r&&(e&&(r=Y===gt(r)?e[1][r]:bt(r,e[1])),s.push(r));return 0},get:function(e,t){var n=this,r=n.ta,o=n.tk,l=n.tt,s=n.id,i=null;if(n.MSG=null,n.ACTER=0,x===l)return n.ERR=0,n.REQ=0,!0;if(b===l){if(e.spc(),e.eol())return s}else if(S===l)n.ERR=n.REQ&&e.spc()&&!e.eol()?1:0,n.REQ=0;else if(i=o.get(e))return r&&(n.ACTER=n.act(i,t)),s;return!1},req:function(e){return this.REQ=!!e,this},err:function(){var e=this;return e.MSG?e.MSG:e.REQ?'Token "'+e.id+'" Expected':'Syntax Error: "'+e.id+'"'},clone:function(){var e,t,n,r=this,o=r.CLONE;if(e=new r.constructor,e.tt=r.tt,e.id=r.id,e.ta=r.ta?r.ta.slice():r.ta,o&&o.length)for(t=0,n=o.length;n>t;t++)e[o[t]]=r[o[t]];return e},toString:function(){var e=this;return["[","Tokenizer: ",e.id,", Matcher: ",e.tk?e.tk.toString():null,"]"].join("")}}),Kt=dt(Ft,{constructor:function(e,t,n,r,o,l){var s=this;s.tt=e,s.id=t,s.tk=n,s.REQ=0,s.ERR=0,s.ACTER=0,s.MSG=null,s.mline="undefined"==typeof r?1:r,s.esc=o||"\\",s.inter=l,s.CLONE=["tk","mline","esc","inter"]},inter:0,mline:0,esc:null,get:function(e,t){var n,r,o,l,s,i,u,c,a,p=this,f=0,h=0,g="",m=p.mline,k=p.tk,d=p.id,E=p.tt,v=p.inter,R=v?d+".inside":d,w=0,y=O===E,C=p.esc;if(p.MSG=null,p.ACTER=0,T===E&&(p.REQ=0),s=0,t.inBlock===d?(h=1,n=t.endBlock,s=1,i=R):!t.inBlock&&(n=k.get(e))&&(h=1,t.inBlock=d,t.endBlock=n,i=d),h){if(o=t.stack.pos(),l=ct===n.tt,v){if(s&&l&&e.sol())return p.REQ=0,t.inBlock=null,t.endBlock=null,!1;if(!s)return t.stack.pushAt(o,p.clone(),"sID",d),i}if(f=n.get(e),r=m,a=0,f)i=l?R:d;else for(c=e.pos;!e.eol();){if(u=e.pos,!(y&&w||!n.get(e))){v&&e.pos>u&&u>c?(i=R,e.bck2(u),a=1):(i=d,f=1);break}g=e.nxt(),w=!w&&g==C}return r=m||y&&w,f||!r&&!a?(t.inBlock=null,t.endBlock=null):t.stack.pushAt(o,p.clone(),"sID",d),i}return!1}}),Vt=dt(Ft,{constructor:function(e,t,n,r,o){var l=this;l.tt=e?e:I,l.id=t||null,l.tk=null,l.ts=null,l.REQ=0,l.ERR=0,l.ACTER=0,l.MSG=null,l.min=r||0,l.max=o||R,l.found=0,l.CLONE=["ts","min","max","found"],n&&l.set(n)},ts:null,min:0,max:1,found:0,set:function(e){return e&&(this.ts=Et(e)),this},get:function(e,t){var n,r,o,l,s,i,u,c,a,p,f,h,g=this,m=g.tt,k=g.ts,d=k.length;if(L===m){for(u=0,c=0,g.REQ=1,g.ERR=0,g.ACTER=0,g.MSG=null,a=e.pos,n=0;d>n;n++){if(r=k[n].clone().req(1),o=r.get(e,t),u+=r.REQ?1:0,!1!==o)return g.ACTER=r.ACTER,g.MSG=r.MSG,o;r.ERR&&(c++,e.bck2(a))}return g.REQ=u>0,g.ERR=d==c&&u>0,!1}if(P&m){if(h=m&B?1:0,g.REQ=h,g.ERR=0,g.ACTER=0,g.MSG=null,a=e.pos,p=t.stack.pos(),r=k[0].clone().req(h),o=r.get(e,t),f=g.id+"_"+Dt(),!1!==o){if(!0!==o)for(var n=d-1;n>0;n--)t.stack.pushAt(p+d-n-1,k[n].clone().req(1),"sID",f);return g.ACTER=r.ACTER,g.MSG=r.MSG,o}return r.ERR?(g.ERR=h,e.bck2(a)):h&&r.REQ&&(g.ERR=1),!1}for(u=0,l=g.found,s=g.min,i=g.max,g.ERR=0,g.REQ=0,g.ACTER=0,g.MSG=null,a=e.pos,p=t.stack.pos(),f=g.id+"_"+Dt(),n=0;d>n;n++){if(r=k[n].clone().req(1),o=r.get(e,t),!1!==o){if(++l,i>=l)return g.found=l,t.stack.pushAt(p,g.clone(),"sID",f),g.found=0,g.ACTER=r.ACTER,g.MSG=r.MSG,o;break}r.REQ&&u++,r.ERR&&e.bck2(a)}return g.REQ=s>l,g.ERR=l>i||s>l&&u>0,!1}});var Ht="undefined"!=typeof ace?ace:{require:function(){return{}},config:{}},Yt=Ht.require,Jt=Ht.config,Xt=!("undefined"==typeof global||"[object global]"!==H.call(global)),en=!(Xt||"undefined"==typeof navigator),tn=!!(en&&"function"==typeof importScripts&&navigator instanceof WorkerNavigator),nn=function(){var e,t,n=null;return Xt?(n=__filename,{path:__dirname,file:__filename,base:__dirname}):(tn?n=self.location.href:en&&(e=document.location.href.split("#")[0].split("?")[0].split("/").slice(0,-1).join("/"),(t=document.getElementsByTagName("script"))&&t.length&&(n=t[t.length-1].src)),n?{path:n.split("/").slice(0,-1).join("/"),file:n,base:e}:{path:null,file:null,base:null})},rn=nn(),on=dt(Yt("ace/worker/worker_client").WorkerClient,{constructor:function(e,t,n){var r=this,o=Yt,l=Jt;r.$sendDeltaQueue=r.$sendDeltaQueue.bind(r),r.changeListener=r.changeListener.bind(r),r.onMessage=r.onMessage.bind(r),o.nameToUrl&&!o.toUrl&&(o.toUrl=o.nameToUrl);var s;if(l.get("packaged")||!o.toUrl)s=l.moduleUrl(t,"worker");else{var i=r.$normalizePath;s=i(o.toUrl("ace/worker/worker.js",null,"_"));var u={};e.forEach(function(e){u[e]=i(o.toUrl(e,null,"_").replace(/(\.js)?(\?.*)?$/,""))})}r.$worker=new Worker(s),r.$worker.postMessage({load:!0,ace_worker_base:rn.base+"/"+Jt.moduleUrl("ace/worker/json")}),r.$worker.postMessage({init:!0,tlns:u,module:t,classname:n}),r.callbackId=1,r.callbacks={},r.$worker.onmessage=r.onMessage}});k="text",d="invalid";var ln=dt(Yt("ace/tokenizer").Tokenizer,{constructor:function(e,t){var n,r=this;r.LC=e.Comments.line||null,r.BC=e.Comments.block?{start:e.Comments.block[0][0],end:e.Comments.block[0][1]}:null,r.LC&&(n=ot&gt(r.LC)?r.LC.map(Ct).join("|"):Ct(r.LC),r.rxLine=new RegExp("^(\\s*)(?:"+n+") ?")),r.BC&&(r.rxStart=new RegExp("^(\\s*)(?:"+Ct(r.BC.start)+")"),r.rxEnd=new RegExp("(?:"+Ct(r.BC.end)+")\\s*$")),r.DEF=t.DEFAULT,r.ERR=e.Style.error||t.ERROR,r.Keywords=e.Keywords.autocomplete||null,r.Tokens=e.Parser||[],r.cTokens=e.cTokens.length?e.cTokens:null,r.Style=e.Style},ERR:null,DEF:null,LC:null,BC:null,rxLine:null,rxStart:null,rxEnd:null,Keywords:null,cTokens:null,Tokens:null,Style:null,dispose:function(){var e=this;return e.ERR=null,e.DEF=null,e.LC=null,e.BC=null,e.rxLine=null,e.rxStart=null,e.rxEnd=null,e.Keywords=null,e.cTokens=null,e.Tokens=null,e.Style=null,e},parse:function(e){e=e||"";var t,n,r=this,o=e.split(Ot),l=o.length,s=[];for(n={state:new Zt,tokens:null},t=0;l>t;t++)n=r.getLineTokens(o[t],n.state,t),s.push(n.tokens);return s},getLineTokens:function(e,t,n){var r,o,l,s,i,u,c,a,p,f,h,g=this,m=g.cTokens,k=g.Tokens,d=k.length,E=null,v=g.DEF,R=g.ERR,w=g.Style;for(u=[],f=new qt(e),t=t?t.clone(1):new Zt(1,1),t.l=1+n,h=t.stack,c={type:null,value:"",error:null},a=null,p=null,f.sol()&&!h.isEmpty()&&b===h.peek().tt&&h.pop();!f.eol();)if(o=0,p&&p!==c.type?(c.type&&u.push(c),c={type:p,value:f.cur(1),error:E},E=null):c.type&&(c.value+=f.cur(1)),p=!1,!h.isEmpty()&&S===h.peek().tt||!f.spc()){for(;!h.isEmpty()&&!f.eol();){if(m){for(s=0,l=0;s<m.length;)if(i=m[s++],t.t=a=i.get(f,t),!1!==a){p=w[a]||v,l=1;break}if(l){o=1;break}}if(i=h.pop(),t.t=a=i.get(f,t),!1!==a){if(!0!==a){p=w[a]||v,i.ACTER&&(h.empty("sID",i.sID),t.t=a=R,p=R,E=i.err()),o=1;break}}else{if(i.ERR||i.REQ){h.empty("sID",i.sID),f.nxt(),t.t=a=R,p=R,E=i.err(),o=1;break}p=!1}}if(!o){if(f.eol())break;for(r=0;d>r;r++)if(i=k[r],t.t=a=i.get(f,t),!1!==a){if(!0!==a){p=w[a]||v,i.ACTER&&(h.empty("sID",i.sID),t.t=a=R,p=R,E=i.err()),o=1;break}}else{if(i.ERR||i.REQ){h.empty("sID",i.sID),f.nxt(),t.t=a=R,p=R,E=i.err(),o=1;break}p=!1}if(!o){if(f.eol())break;f.nxt(),t.t=a=v,p=v}}}else t.t=a=v,p=v;return p&&p!==c.type?(c.type&&u.push(c),u.push({type:p,value:f.cur(1),error:E}),E=null):c.type&&(c.value+=f.cur(1),u.push(c)),c=null,{state:t,tokens:u}},tCL:function(e,t,n,r){var o,l,s,i,u,c=this,a=t.doc,p=!0,f=!0,h=1/0,g=t.getTabSize(),m=!1;if(c.LC){var k,d=ot===gt(c.LC)?c.LC[0]:c.LC,E=c.rxLine,v=d+" ";m=t.getUseSoftTabs(),s=function(e,t){var n,r,o=e.match(E);o&&(n=o[1].length,r=o[0].length,u(e,n,r)||" "!=o[0][r-1]||r--,a.removeInLine(t,n,r))},l=function(e,t){(!p||/\S/.test(e))&&(u(e,h,h)?a.insertInLine({row:t,column:h},v):a.insertInLine({row:t,column:h},d))},i=function(e){return E.test(e)},u=function(e,t,n){for(var r=0;t--&&" "==e.charAt(t);)r++;if(r%g!=0)return!1;for(r=0;" "==e.charAt(n++);)r++;return g>2?r%g!=g-1:r%g==0}}else{if(!c.BC)return!1;var d=c.BC.start,R=c.BC.end,w=c.rxStart,y=c.rxEnd;l=function(e,t){i(e,t)||(!p||/\S/.test(e))&&(a.insertInLine({row:t,column:e.length},R),a.insertInLine({row:t,column:h},d))},s=function(e,t){var n;(n=e.match(y))&&a.removeInLine(t,e.length-n[0].length,e.length),(n=e.match(w))&&a.removeInLine(t,n[1].length,n[0].length)},i=function(e,n){if(w.test(e))return!0;for(var r=t.getTokens(n),o=0;o<r.length;o++)if("comment"===r[o].type)return!0}}o=function(e){for(var t=n;r>=t;t++)e(a.getLine(t),t)},k=1/0,o(function(e,t){var n=e.search(/\S/);-1!==n?(h>n&&(h=n),f&&!i(e,t)&&(f=!1)):k>e.length&&(k=e.length)}),1/0==h&&(h=k,p=!1,f=!1),m&&h%g!=0&&(h=Math.floor(h/g)*g),o(f?s:l)},tBC:function(e,t,n,r){var o,l,s,i,u,c,a,p,f,h,g,m=this,k=Yt("ace/token_iterator").TokenIterator,d=Yt("ace/range").Range,E=m.BC,v=/comment/;if(E){if(o=new k(t,r.row,r.column),l=o.getCurrentToken(),s=t.selection,i=s.toOrientedRange(),l&&v.test(l.type)){for(;l&&v.test(l.type);){if(f=l.value.indexOf(E.start),-1!=f){h=o.getCurrentTokenRow(),g=o.getCurrentTokenColumn()+f,a=new d(h,g,h,g+E.start.length);break}l=o.stepBackward()}for(o=new k(t,r.row,r.column),l=o.getCurrentToken();l&&v.test(l.type);){if(f=l.value.indexOf(E.end),-1!=f){h=o.getCurrentTokenRow(),g=o.getCurrentTokenColumn()+f,p=new d(h,g,h,g+E.end.length);break}l=o.stepForward()}p&&t.remove(p),a&&(t.remove(a),u=a.start.row,c=-E.start.length)}else c=E.start.length,u=n.start.row,t.insert(n.end,E.end),t.insert(n.start,E.start);i.start.row==u&&(i.start.column+=c),i.end.row==u&&(i.end.column+=c),t.selection.fromOrientedRange(i)}},indent:function(e){return e.match(/^\s*/)[0]},getNextLineIndent:function(e,t){return t.match(/^\s*/)[0]}});tn&&(onmessage=function(e){var t=e.data;t.load&&t.ace_worker_base&&(importScripts(t.ace_worker_base),g())});e.AceGrammar={VERSION:"1.0.3",clone:Rt,extend:wt,parse:h,getMode:m};return e.AceGrammar});/*
 * PEG.js 0.9.0
 *
 * http://pegjs.org/
 *
