...
/*! Develoop 0.0.12 //// MIT Licence //// http://develoop.oopish.com/ */
...
(function() {
      ...
      this.oopish.push(new Directory(this, {
        ...
        files: [
          new File(this, {
            ...
            value: "//// Mode generated by Develoop 0.0.7\n\nmodeGrammar = {\n}\n"
          }), new File(this, {
      ...
      this.oopish.push(new Directory(this, {
        ...
        files: [
          new File(this, {
            ...
            editable: true,
            value: "//// Grammar helpers generated by Develoop 0.0.7\nvar someHelper = function () { return 'ok'; };\n"
          }), new File(this, {
            ...
            editable: true,
            value: "//// Grammar rules generated by Develoop 0.0.7\n\nmodeGrammar = {\n}\n"
          })
        ]
      }));
      this.oopish.push(new Directory(this, {
  ...
  tudor.add([
    "01 Develoop Constructor Usage", tudor.is, "(Set up a `main` instance)", function() {
      return [new Main];
    }, "The class and instance are expected types", "The Develoop class is a function", ªF, function() {
      return Main;
    }, "`new` returns an object", ªO, function(main) {
      return main;
    }, "`pegjs` is an object", ªO, function(main) {
      return main.pegjs;
    }, tudor.equal, "`Develoop.toString()` is '[object Develoop]'", '[object Develoop]', function(main) {
      return '' + main;
